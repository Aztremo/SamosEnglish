...
Dashboard::headerTemplate('Tipo perfiles');
?>
...
<main>
    ...
    <table class=" highlight centered white-text">
        ...
        <thead>
            <tr>
                <th>Tipo perfil</th>
                <th><a href="#" onclick="openCreateModal()" class=" waves-effect tooltipped" data-tooltip="Agregar Tipo"><i class="small material-icons green-text text- accent-4">add_circle</i></a></th>
            </tr>
        </thead>
        ...
        <form method="post" id="save-form" enctype="multipart/form-data">
            ...
            <div class="row center-align">
                <div class="input-field center-align">
                    ...
                    <label for="nombreTipo">Tipo de perfil</label>
                </div>
            </div>
            <div class="row center-align">
...
<?php
Dashboard::footerTemplate('tipoperfil.js');
?>
