    ...
    <table class=" highlight centered white-text">
        ...
        <thead>
            <tr>
                ...
                <th><a href="#" onclick="openCreateModal()" class=" waves-effect tooltipped" data-tooltip="Add subject type name"><i class="small material-icons green-text text- accent-4">add_circle</i></a></th>
            </tr>
        </thead>
        ...
        <form method="post" id="save-form" enctype="multipart/form-data">
            ...
            <div class="row center-align">
                <div class="input-field center-align">
                    ...
                    <label for="nombretipo">Subject type name</label>
                </div>
            </div>
            <div class="row center-align">
