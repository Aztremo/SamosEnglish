...
<main>
    ...
    <table class=" highlight centered white-text">
        ...
        <thead>
            <tr>
                <th>NAME STATE PROFILE</th>
                <th><a href="#" onclick="openCreateModal()" class=" waves-effect tooltipped" data-tooltip="Add state profile name"><i class="small material-icons green-text text- accent-4">add_circle</i></a></th>
            </tr>
        </thead>
        ...
        <form method="post" id="save-form" enctype="multipart/form-data">
            ...
            <div class="row center-align">
                <div class="input-field center-align">
                    ...
                    <label for="nombreestado">Name State profile</label>
                </div>
            </div>
            <div class="row center-align">
