...
Dashboard::headerTemplate('Estado Perfil');
?>
...
<main>
    ...
    <table class=" highlight centered white-text">
        ...
        <thead>
            <tr>
                <th>NOMBRE ESTADO PERFIL</th>
                <th><a href="#" onclick="openCreateModal()" class=" waves-effect tooltipped" data-tooltip="Agregar Estado Perfil"><i class="small material-icons green-text text- accent-4">add_circle</i></a></th>
            </tr>
        </thead>
    ...
    <div class="modal-content">
        ...
        <form method="post" id="save-form" enctype="multipart/form-data">
            ...
            <input class="hide" type="text" id="id_estadoperfil" name="id_estadoperfil"/>
            <div class="row center-align">
                <div class="input-field center-align">
                    ...
                    <label for="nombreestado">Nombre Estado Perfil</label>
                </div>
            </div>
            <div class="row center-align">
...
<?php
Dashboard::footerTemplate('estadoperfil.js');
?>
