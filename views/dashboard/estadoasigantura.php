...
Dashboard::headerTemplate('Subject status');
?>
...
<main>
    ...
    <table class=" highlight centered white-text">
        ...
        <thead>
            <tr>
                <th>STATE NAME</th>
                <th><a href="#" onclick="openCreateModal()" class=" waves-effect tooltipped" data-tooltip="Add subject status"><i class="small material-icons green-text text- accent-4">add_circle</i></a></th>
            </tr>
        </thead>
    ...
    <div class="modal-content white-text">
        ...
        <form method="post" id="save-form" enctype="multipart/form-data">
            ...
            <input class="hide" type="text" id="id_estadoasignatura" name="id_estadoasignatura"/>
            <div class="row center-align">
                <div class="input-field center-align">
                    ...
                    <label for="nombreestado">State Name</label>
                </div>
            </div>
            <div class="row center-align">
...
<?php
Dashboard::footerTemplate('estadoasignatura.js');
?>
