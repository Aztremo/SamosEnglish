...
const API_TIPO = '../../core/api/dashboard/tipoasignatura.php?action=';
...
function openUpdateModal( id )
{
    ...
    .done(function( response ) {
        ...
        if ( response.status ) {
            ...
            $( '#id_tipoasignatura' ).val( response.dataset.id_tipoasignatura );
            $( '#nombretipo' ).val( response.dataset.tipoasignatura );
...
function openDeleteDialog( id )
{
    ...
    let identifier = { id_tipoasignatura: id };
    // Se llama a la función que elimina un registro. Se encuentra en el archivo components.js
    confirmDelete( API_TIPO, identifier );
}