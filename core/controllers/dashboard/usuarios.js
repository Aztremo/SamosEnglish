    ...
    dataset.forEach(function( row ) {
        ...
        content += `
            <tr>
                ...
                <td>
                    <a href="#" onclick="openUpdateModal(${row.id_usuario})" class="blue-text tooltipped" data-tooltip="Update"><i class="material-icons">mode_edit</i></a>
                    <a href="#" onclick="openDeleteDialog(${row.id_usuario})" class="red-text tooltipped" data-tooltip="Delete"><i class="material-icons">delete</i></a>
                </td>
            </tr>
        `;
    });
